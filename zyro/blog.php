...
<head>
	...
	<style type="text/css">
		...
		#wb_element_instance67 ul { background: #79ff3b none no-repeat scroll left top; border: 1px none #000000; text-align: left; }
		#wb_element_instance67 ul ul { background: transparent none no-repeat scroll left top; }
		#wb_element_instance67 li { margin: 0px 20px 0px 20px; }
		#wb_element_instance67 li a { text-transform: uppercase; border: 0px none #000000; padding: 15px 20px 15px 20px; font: normal bold 14px Arial,Helvetica,sans-serif; text-align: left; text-decoration: none; color: #000000; line-height: 16px; background: transparent none repeat scroll left top; }
		#wb_element_instance67 li a:hover { border: 0px none #000000; font: normal bold 14px Arial,Helvetica,sans-serif; text-align: left; text-decoration: none; color: #1c1c1c; line-height: 16px; background: #ffffff none repeat-x scroll left top; }
		#wb_element_instance67 li.active > a { border: 0px none #000000; font: normal bold 14px Arial,Helvetica,sans-serif; text-align: left; text-decoration: none; color: #050505; line-height: 16px; background: #ffffff none repeat scroll left top; }
	</style>
...
<body><div class="root" style="width: 1007px;"><div class="vbox wb_container" id="wb_main" style="height: 236px;">
	
<div id="wb_element_instance67" class="wb_element" style="left: 20px; top: 90px; width: 961px; height: 46px; min-width: 961px; min-height: 46px; z-index: 267;"><script type="text/javascript">
				$(function() {
					$("#wb_element_instance67").children("ul").children().each(function() {
			...
			</script><ul class="hmenu"><li><a href="Home-2/" target="_self" title="Home">Home</a></li><li><a href="Sobre-mi-2/" target="_self" title="Sobre mi">Sobre mi</a></li><li><a href="Contacts-2/" target="_self" title="Contacts">Contacts</a></li></ul></div><div id="wb_element_instance68" class="wb_element" style="left: 39px; top: 23px; width: 380px; height: 43px; min-width: 380px; min-height: 43px; z-index: 63;  line-height: normal;"><h4 class="wb-stl-pagetitle">Maria Angeles Blanco</h4>
</div><div id="wb_element_instance69" class="wb_element" style="left: 957px; top: 34px; width: 24px; height: 23px; min-width: 24px; min-height: 23px; z-index: 69;"><a href="http://facebook.com"><img alt="" src="gallery/d79712d6d9595f661588582556ae6eec_24x23.png" style="width: 24px; height: 23px;"></a></div><div id="wb_element_instance70" class="wb_element" style="left: 923px; top: 34px; width: 24px; height: 23px; min-width: 24px; min-height: 23px; z-index: 70;"><a href="http://twitter.com"><img alt="" src="gallery/d8e63c4e3ab13d2207973b945585e20b_24x23.png" style="width: 24px; height: 23px;"></a></div><div id="wb_element_instance71" class="wb_element" style="left: 15px; top: 26px; width: 231px; height: 24px; min-width: 231px; min-height: 24px; z-index: 62;  line-height: normal;"><p class="wb-stl-footer">© 2014 <a href="http://mablancomakeup.com.ar">mablancomakeup.com.ar</a></p></div><div id="wb_element_instance72" class="wb_element" style="left: 0px; top: 156px; min-width: 0px; min-height: 0px; z-index: 9000; width: 100%;">
			<?php
			...
			?>
			</div><div id="wb_element_instance73" class="wb_element" style="left: 0px; top: 176px; min-width: 0px; min-height: 0px; z-index: 9999; text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
