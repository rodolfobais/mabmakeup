...
$textoquiensoy = $fn->getParametro('quiensoy');

$_SESSION['page'] = 'quiensoy.php';

$misTrabajos = $fn->getMisTrabajos(500);
$imagenPpal = "portada_quiensoy.jpg?v=".$_SESSION['date'];
...
<html lang="es">
	...
	<body>
		<div class="root" style="width: 1007px; height: 670px;">
			<div class="vbox wb_container" id="wb_header" style='height: 150px;'>
			...
			<div class="vbox wb_container" id="wb_main"	style="height: 400px; background: transparent none repeat scroll left top; padding: 0 0 50px 0; overflow:auto;">
				<br/><span class="wb-stl-heading1">Quién soy</span>
				...
				<table border = 0 height = 320 width = 985 style = "vertical-align:text-top; height: 330px;">
					<tr style = "height: 330px;">
						<td style = "width: 330px;">
							<img onclick = "abrirmodal('gallery/portada_quiensoy.jpg')" alt="" src="gallery/portada_quiensoy.jpg" style="width: 320px;">
						</td>
						<td style = "vertical-align:text-top;	">
							<span class="wb-stl-normal" style = "height: 330px;overflow:auto;"><?php echo $textoquiensoy;?></span>
						</td>
					</tr>
				</table>
			</div>
